-- Fix salary RPC for Bank-stability 3.0.
-- Compatible with the current admin.js call:
-- pay_salary_direct(p_user_id, p_job, p_params)
...
declare
  ...
  v_units integer := greatest(0, coalesce((p_params->>'orders')::integer, 0));
